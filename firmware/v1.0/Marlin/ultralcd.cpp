...
//    MENU_ITEM(gcode, MSG_LOAD_FILAMENT, PSTR("G21 G F1000 E600"));
//    MENU_ITEM(gcode, MSG_UNLOAD_FILAMENT, PSTR("G21 G F1000 E-600"));
//    MENU_ITEM(gcode, MSG_FEED_FILAMENT, PSTR("G21 G F200 E10"));
...
static void lcd_control_motion_menu()
{
    ...
    MENU_ITEM_EDIT(float32, MSG_ZPROBE_ZOFFSET, &zprobe_zoffset, 0, 10);
#endif
