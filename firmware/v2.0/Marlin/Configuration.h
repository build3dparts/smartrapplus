...
#define PID_MAX 240 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#ifdef PIDTEMP
...
#endif
#ifdef motors18gt2
   #define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,100}  // smartrap : version 1.8degv{194,194,4000,85} robotdigg.shaft adaptor,fishline big
#endif
#ifdef motors09gt2
...
#define DEFAULT_MAX_ACCELERATION      {2500,2500,100,8000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
#define PLA_PREHEAT_FAN_SPEED 150   // Insert Value between 0 and 255
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 35,10} // X,Y,Z Axis Extend and Retract angles
#endif
